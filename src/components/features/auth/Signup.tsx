            ...
            <div className="space-y-4 sm:space-y-6">
              <div>
                ...
                <div className="relative">
                  <div className="hidden sm:block absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 sm:py-3 pl-3 sm:pl-12 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm sm:text-base leading-normal"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-3 py-2.5 sm:py-3 pl-3 sm:pl-12 pr-3 sm:pr-12 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent text-sm sm:text-base leading-normal"
                    placeholder="Enter your password"
                  />
                  <button
                    type="button"
                    className="hidden sm:flex absolute inset-y-0 right-0 pr-3 items-center hover:text-gray-300 transition-colors duration-200 min-w-[44px] min-h-[44px] z-20"
